...
module.exports = function (webpackEnv, target = "web") {
                ...
                presets: [
                  [
                    require.resolve("babel-preset-react-app"),
                    {
                      ...
                      // we set es module to falsy in node environment as it will be to compatible issue in node js.
                      //Generally node js support commonjs version. In browser environment, leave this to babel.
                      useESModules: isNodeTarget ? false : undefined,
                    },
                  ],
                ],
                // @remove-on-eject-begin
  ...
  return applyNodeConfigurations(config, target, isEnvProduction);
};
